...
import { exportSPSS, exportJSON } from '../utils/exportData';
...
export default function CompletionPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      exportSPSS(results);
      setTimeout(() => exportJSON(results), 500);
    }, 500);
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-lg animate-fadeIn">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-base text-slate-500">感谢您的参与，成果数据已自动保存。</p>
        </div>
        ...
        <div className="panel p-6 space-y-5">
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-emerald-600 bg-emerald-50 rounded-xl px-4 py-3 border border-emerald-200">
            ...
            <span>结果文件已自动下载，请查收浏览器下载目录</span>
          </div>
